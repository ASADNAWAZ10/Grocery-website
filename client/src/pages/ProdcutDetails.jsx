...
const ProductDetails = () => {
  ...
  if(!product){
    return <h1 className="font-bold text-2xl text-center m-4">Loading....</h1>
  }
  ...
  useEffect(() => {
    ...
    productCopy = productCopy.filter(
        (items) => products.category === items.category && items._id !== products._id
      );
      ...
      <div className="mt-12">
          ...
          <div className="text-sm w-full md:w-1/2">
            ...
            <div className="flex items-center gap-0.5 mt-1">
              {Array(5)
                ...
                .map((_, i) => (
                  <img
                    src={i < 4 ? asset.starIcon : asset.star_Icon}
        ...
        <div className="flex flex-col items-center mt-20">
          <div className="flex flex-col items-center w-max">
            <p className="text-2xl font-medium">Realated Product</p>
          ...
          <button
            ...
            className="mx-auto cursor-pointer px-12 my-16 py-2.5 border rounded text-primary 
